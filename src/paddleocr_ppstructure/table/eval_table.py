...
from paddleocr_ppstructure.table.predict_table import TableSystem
from paddleocr_ppstructure.table.table_metric import TEDS
from paddleocr_ppstructure.utility import init_args
