...
from paddleocr_ppocr.utils.logging import get_logger
from paddleocr_ppocr.utils.utility import check_and_read, get_image_file_list
from paddleocr_ppocr.utils.visual import draw_re_results, draw_ser_results
from paddleocr_ppstructure.layout.predict_layout import LayoutPredictor
from paddleocr_ppstructure.table.predict_table import TableSystem, to_excel
from paddleocr_ppstructure.utility import draw_structure_result, parse_args
...
class StructureSystem(object):
    def __init__(self, args):
        ...
        if self.mode == 'structure':
            ...
            from paddleocr_ppstructure.kie.predict_kie_token_ser_re import (
                SerRePredictor,
            )
    ...
    for i, image_file in enumerate(image_file_list):
        ...
        for index, img in enumerate(imgs):
            ...
            if args.recovery and res != []:
                from paddleocr_ppstructure.recovery.recovery_to_doc import (
                    convert_info_docx,
                    sorted_layout_boxes,
                )
                h, w, _ = img.shape
