...
from paddleocr_ppocr.utils.network import download_with_progressbar
from paddleocr_ppstructure.predict_system import StructureSystem, save_structure_res
